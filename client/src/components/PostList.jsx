...
const PostList = () => {
  ...
  const onClickLoadHandler = async () => {
    setExtraLoading(true);
    dispatch(setPageNumber(config.pageNumber + 1)).then(() => {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <NewPostButton
          ...
          text="Create Post"
          icon={FaPlus}
          className="text-xl bg-green-500 text-white hover:bg-green-600 mr-6"
        ></NewPostButton>
      </div>
          ...
          <div className="flex items-center justify-center space-x-10">
            {extraLoading ? (
              ...
              <Button
                ...
                className="bg-green-500 text-white hover:bg-blue-800"
                onClickHandler={onClickLoadHandler}
              />
            )}
          </div>
        )}
